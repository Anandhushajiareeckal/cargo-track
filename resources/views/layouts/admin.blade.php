...
<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        <a href="/admin1" class="logo logo-dark">
            <span class="logo-sm">
                <img src="{{asset('admin/assets/images/logo-sm.png')}}" alt="" height="22">
            </span>
            <span class="logo-lg">
                <img src="{{asset('admin/assets/images/fav.png')}}" alt="" height="22">
            </span>
        </a>
        <a href="/admin1" class="logo logo-light">
            <span class="logo-sm">
                <img src="{{asset('admin/assets/images/logo-sm.png')}}" alt="" height="22">
            </span>
            <span class="logo-lg ">
                <img src="{{asset('admin/assets/images/fav.png')}}" alt="" height="100">
            </span>
        </a>
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link collapsed" href="#sidebarDashboards" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarDashboards">
                        <i class="ti ti-list"></i> <span data-key="t-dashboards">Home</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarDashboards">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="/home-banner" class="nav-link" data-key="t-analytics"> Banner </a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link collapsed" href="#sidebarDashboards1" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarDashboards">
                        <i class="ti ti-list"></i> <span data-key="t-dashboards">About us</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarDashboards1">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="/admin-about" class="nav-link" data-key="t-analytics"> About </a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link collapsed" href="#sidebarDashboards2" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarDashboards">
                        <i class="ti ti-list"></i> <span data-key="t-dashboards">News</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarDashboards2">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="/admin-news" class="nav-link" data-key="t-analytics"> List </a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link collapsed" href="#sidebarDashboards3" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarDashboards">
                        <i class="ti ti-list"></i></i> <span data-key="t-dashboards">Contact</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarDashboards3">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="/admin-contact/1/edit" class="nav-link" data-key="t-analytics"> Edit </a>
                            </li>

                            <li class="nav-item">
                                <a href="/admin-message" class="nav-link" data-key="t-analytics"> Messages </a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link collapsed" href="#sidebarDashboards4" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarDashboards">
                        <i class="ti ti-list"></i></i> <span data-key="t-dashboards">Location</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarDashboards4">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="/admin-location" class="nav-link" data-key="t-analytics"> Add </a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    {{-- <a class="nav-link menu-link collapsed" href="#sidebarDashboards4" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarDashboards">
                        <i class="ti ti-brand-google-home"></i> <span data-key="t-dashboards"><button type="submit">kavcfg</button>        
                        </span>
                    </a> --}}
                    <input type="submit" value="Logout" class="nav-link menu-link collapsed" onclick="return confirm('Are you sure you want to Logout?')">
...
<!-- Mirrored from themesbrand.com/vixon/layouts//admin1 by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Sep 2023 12:09:51 GMT -->
</html>